# Generated by Django 3.2.13 on 2022-10-07 22:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['client_id', 'enterprise_id', 'team_id', 'user_id', 'installed_at'], name='slack_slack_client__644b24_idx'),
        ),
        migrations.AddIndex(
            model_name='slackbot',
            index=models.Index(fields=['client_id', 'enterprise_id', 'team_id', 'installed_at'], name='slack_slack_client__f1774a_idx'),
        ),
    ]
